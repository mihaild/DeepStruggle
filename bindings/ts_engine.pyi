...
class GameState:
    ...
    @property
    def defcon_dropped_to_2_in_ar(self) -> int: ...

    @defcon_dropped_to_2_in_ar.setter
    def defcon_dropped_to_2_in_ar(self, arg: int, /) -> None: ...
...
class Engine:
    ...
    @staticmethod
    def step(arg0: GameState, arg1: MicroAction, /) -> bool: ...
    ...
    @staticmethod
    def step_flat(arg0: GameState, arg1: int, /) -> bool: ...
...
class VectorizedBatchRunner:
    ...
    def step_flat_all(self, arg: Sequence[int], /) -> list[int]: ...
