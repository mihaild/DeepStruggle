...
**Status: CLOSED, 2026-09-24** -- by the owner's criterion (a collapse matters only if training dies or is delayed for a long time), collapse on the production recipe is a recoverable delay, and the damaging form was the pool resume bug, fixed in `3803d5d`. No lever is adopted. Verdict and the partial 3j-3l bench: [`../../../log/P25_stress_bench.md`](../../../log/P25_stress_bench.md#closing-p25-2026-09-24). Step 5's codified rewind moves to [`reserve`](../../../plans/reserve.md). The history below is as it stood.

**Was:** running. The step-3 bench is done ([`../log/P25_stress_bench.md`](../../../log/P25_stress_bench.md)). No lever passes on both seeds with a gain:
...
This comes before [P24](../../../plans/P24_league.md) and before any long run. A league trained on a process
