...
| **How often does a side collapse happen?** | E4-08 census, 32 seeds; E4-11 extensions; 7 continuation arms | **settled, and the earlier answer is withdrawn.** ~12.5% of seeds are *inside an entry episode* at 80M, but that is not an outcome: **5 of 7 recover** when continued, and a recovered collapse costs **−1.4 Elo** (0.05 pooled sd) against arms that never collapsed. Only non-recovery costs anything, **−394 Elo**, seen in 2 of 7 | [log/E4_collapse_is_recoverable.md](log/E4_collapse_is_recoverable.md) |
