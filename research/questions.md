...
| question | arms | verdict | where |
|:---|:---|:---|:---|
| Is the structured backbone worth it over an MLP? | E3-09 vs E3-01 | **settled** — structure is worth ~110 Elo at 2.6× fewer parameters | [findings/training/architecture.md](archive/E3_ladder/findings/architecture.md) |
