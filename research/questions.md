...
| **Does training past 80M keep paying?** | E4-11, six seeds rated at both budgets | **settled for M2d** — **+159.8 Elo** from 80M to 160M, sd 33.7, measured *within-seed* so the ~100 Elo seed spread cancels out. Not tested past 160M | [log/P21_M2d_160M_slope.md](log/P21_M2d_160M_slope.md) |
| **How often does a side collapse happen?** | E4-08 census, 32 distinct seeds; E4-11 extensions | **settled** — **12.5% by 80M**, ~19% by 160M, costing ~250 Elo and landing the arm below M1. Bitwise reproducible. Entering the pinned state and escaping costs nothing detectable | [findings/training/side_collapse.md](findings/training/side_collapse.md) |
...
| **Is the anchor stable past 80M?** | E4-12-01 | **open — one arm, no replicate.** It lost **356 Elo** over its second 80M with *every* collapse indicator healthy: the policy became indecisive rather than one-sided, and Elo mirrored policy entropy inversely. A second arm is ~3.9 GPU-h | [findings/training/entropy_inflation.md](findings/training/entropy_inflation.md) |
