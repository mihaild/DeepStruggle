...
| **Does online search distillation help on E4?** | **yes, on both seeds tried.** E3's X4b configuration beats the step-matched control at every snapshot on both seats: +54 to +194 Elo on seed 3 (160→190M, 6 snapshots), +157 to +230 on seed 5 (80→95M, 3 snapshots). 20M steps with search beat 80M without. The gain is a level reached within 5M, not a slope. Cost: ~40x slower per step | [log/E4_search_distillation.md](log/E4_search_distillation.md) |
