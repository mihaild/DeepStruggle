...
| **E4.1-05-36** | E4.1 warm-started from a distillation of E4-08-36@80M with exact action translation (`tools/lib/merged_targets.py`; KL 0.044 at op-choice, top-1 91.9%), then the E4-08 recipe with `--merged-influence`, seed 36, 80M. A warm start: fresh optimizer, π_ref and pool. Compared with E4-08-36@80–160M | 0 → 80M (from E4-08-36@80M) | `E4.1-05-36_20260924_190850`; student `E4.1-05-36-distilled6_20260924_190531` | *running* |
