...
| **E4-57-43, E4-57-44** | Long runs: today's default recipe (the E4-57 configuration: E4-08 recipe, M2d, λ 0.98, pool 0.3/12, TF32, snapshots every 10M, pool every 5M), seeds 43 and 44, from scratch to 800M in one run each, as a pair (~5 h). What training time alone buys | 0 → 800M | `E4-57-4{3,4}_20260925_*` | *running* |
