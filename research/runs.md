...
| **E4-60-43** | Long run with a weaker z-loss: the E4-57 configuration plus `--z-loss-coef 1e-5`, seed 43, from scratch to 800M, solo | 0 → 800M | `E4-60-43_20260925_074456` | *running* ([`log/E4_long_runs.md`](log/E4_long_runs.md)) |
