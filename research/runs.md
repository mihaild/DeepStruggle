...
| **E4.1-03-36** | E4.1 with the entropy bonus normalised per decision: E4.1-01-36's flags plus `--entropy-normalize --entropy-coef 0.021` (the default average bonus on E4's decision mix). Tests whether the ~50-option op-mode decisions give the losing seat's bonus the room that drives E4.1's collapse | 0 → 160M | `E4.1-03-36_20260924_175915` | *running* |
