...
| **E4-59-43, E4-59-44** | Long runs with z-loss: the E4-57 configuration (E4-08 recipe, M2d, λ 0.98, pool 0.3/12, TF32, snapshots 10M, pool 5M) plus `--z-loss-coef 1e-4`, seeds 43 and 44 (as E4-57-43/44, which diverged at 232M and 596M through the unbounded logit level), from scratch to 800M, as a pair | 0 → 800M | `E4-59-4{3,4}_20260925_*` | *running* ([`log/E4_long_runs.md`](log/E4_long_runs.md)) |
