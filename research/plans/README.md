...
|:---|:---|:---|:---|
| **[P26](P26_training_throughput.md)** | **current focus (2026-09-24).** Training throughput, first, because a faster step means more experiments in the same time. Quick measurement of TF32, bf16 autocast and `torch.compile` on M2d, and of the snapshot-probe cost, before deciding which to take through the adoption gates | ~1 h of GPU for the quick screen | **running**: quick screen |
...
| where | what |
|:---|:---|
| **P25 (closed)** | [`../archive/E4_ladder/plans/P25_collapse_robustness.md`](../archive/E4_ladder/plans/P25_collapse_robustness.md): collapse on the fixed pool is a recoverable delay; no lever adopted ([`../log/P25_stress_bench.md`](../log/P25_stress_bench.md#closing-p25-2026-09-24)) |
