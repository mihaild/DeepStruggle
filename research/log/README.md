...
| [`E4_search_distillation.md`](E4_search_distillation.md) | — | **online search distillation works on E4, on both seeds tried.** E3's X4b configuration beats its step-matched control at every snapshot on both seats (+54 to +194 on seed 3, +157 to +230 on seed 5), and 20M steps with search beat 80M without. The gain is a level reached within 5M; search still beats the distilled net 59%, so headroom remains |
