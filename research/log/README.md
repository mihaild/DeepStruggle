...
| [`P21_M2d_country_head_collapse.md`](P21_M2d_country_head_collapse.md) | — | the country per-entity head ALONE recovers none of M2's +362 (1776.0 against M1's 1776.3), refuting the prediction that `pe_card` would be inert — type-level card properties are what timing needs. Also **the first collapse observed on E4**, and it reproduces in 30 minutes |
