...
| [`P15_X4a_distillation.md`](P15_X4a_distillation.md) | — | one offline round of expert iteration: +47.7 Elo from distilling a 96-sim searcher at card/play-mode nodes, out of a policy that already agreed with it 93.1% of the time — and the evidence that most of the search edge is somewhere else |
