...
| [`P15_X4b_search_during_rl.md`](P15_X4b_search_during_rl.md) | — | the continuous form: an honest searcher supplies CE targets during RL and never acts, matched one-factor against the step-, seed- and cadence-identical control E3-26-28 — pre-registered, running |
