...
| [`E4_search_distillation.md`](E4_search_distillation.md) | — | **online search distillation beats plain M2d on E4, on both seeds tried — durability unproven.** E3's X4b configuration beats its step-matched control at every snapshot on both seats (+54 to +194 on seed 3 over 7 snapshots, +157 to +232 on seed 5 over 4), and 20M steps with search beat 80M without. The gain is a level reached within 5M; search still beats the distilled net 59%, so headroom remains. E3's identical configuration collapsed 30–36M into its leg with a healthy pool; E4-28-03 stopped at ~36M, no decline yet |
