...
### 3.3 Run Test Suites
```bash
# C++ Unit Tests & Invariant Fuzzer
./build/engine/ts_tests
./build/engine/ts_fuzz

# Python nanobind, Server, & Bot Integration Tests
PYTHONPATH=. .venv/bin/pytest -v tests/
```

### 3.4 Launch Web Workbench & Play Against Bot
```bash
...
## 5. Subdirectory Guides

For component-specific development, refer to:
- [`engine/AGENTS.md`](file:///home/mihaild/prog/ts_ai/engine/AGENTS.md) — C++ engine architecture, card handlers, action masking, micro-decisions.
- [`bindings/AGENTS.md`](file:///home/mihaild/prog/ts_ai/bindings/AGENTS.md) — nanobind bridge, dictionary serialization, types export.
...
- [`bot/AGENTS.md`](file:///home/mihaild/prog/ts_ai/bot/AGENTS.md) — Bot interface, heuristic and random strategies, connecting AI agents.
- [`frontend/AGENTS.md`](file:///home/mihaild/prog/ts_ai/frontend/AGENTS.md) — Vite + TypeScript web client, SVG map, decision HUD, replay scrubber.
