...
TEST(MapTest, SuperpowerAdjacency) {
    ...
    // USSR: Finland(5), Poland(15), Romania(19), Bulgaria(20), Turkey(12), Iran(25), Afghanistan(31), North Korea(43)
    ...
    ASSERT_TRUE(ts::MapData::is_adjacent_to_superpower(ts::countries::BULGARIA, ts::Player::USSR));
    ASSERT_TRUE(ts::MapData::is_adjacent_to_superpower(ts::countries::TURKEY, ts::Player::USSR));
    ASSERT_TRUE(ts::MapData::is_adjacent_to_superpower(ts::countries::IRAN, ts::Player::USSR));
