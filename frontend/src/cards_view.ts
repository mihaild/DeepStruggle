...
export class CardsView {
  ...
  private renderFlags(state: GameState) {
    ...
    if (usSpace >= 2) effectCards.push({ title: "US Animal in Space", side: "US", badge: "Space Perk", desc: "US may discard 1 card at end of turn." });
    if (usSpace >= 4) effectCards.push({ title: "US Man in Space", side: "US", badge: "Space Perk", desc: "US selects headline after viewing USSR headline card." });
    if (usSpace >= 6) effectCards.push({ title: "US Lunar Orbit", side: "US", badge: "Space Perk", desc: "US may attempt Space Race twice per turn." });
    if (usSpace >= 8) effectCards.push({ title: "US Space Station", side: "US", badge: "Space Perk", desc: "US gains an 8th Action Round each turn." });

    if (ussrSpace >= 2) effectCards.push({ title: "USSR Animal in Space", side: "USSR", badge: "Space Perk", desc: "USSR may discard 1 card at end of turn." });
    if (ussrSpace >= 4) effectCards.push({ title: "USSR Man in Space", side: "USSR", badge: "Space Perk", desc: "USSR selects headline after viewing US headline card." });
    if (ussrSpace >= 6) effectCards.push({ title: "USSR Lunar Orbit", side: "USSR", badge: "Space Perk", desc: "USSR may attempt Space Race twice per turn." });
    if (ussrSpace >= 8) effectCards.push({ title: "USSR Space Station", side: "USSR", badge: "Space Perk", desc: "USSR gains an 8th Action Round each turn." });
