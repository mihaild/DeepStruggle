...
def train_pipeline(
    ...
    metadata_info = {
        ...
        "defcon_coef": float(defcon_coef),
        "no_blunder_window": not bool(blunder_window),
        "slice_turn_boundaries": {None: "auto", True: "on", False: "off"}[slice_turn_boundaries],
        "eval_games_per_side": int(eval_games_per_side),
        "eval_max_snapshot_opponents": int(max_snapshot_opponents),
        "start_pool_frac": float(start_pool_frac),
        "start_pool_capacity": int(start_pool_capacity),
        "start_pool_episodes": int(start_pool_episodes),
        "inject_dataset": inject_dataset,
        "inject_every": int(inject_every),
        "inject_weight": float(inject_weight),
