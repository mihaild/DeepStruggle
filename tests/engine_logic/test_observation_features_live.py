...
from ai.eval.feature_audit import audit, collect, v23_features

#: Diagnosed dead, with the reason. Empty for v2.3, and it should stay that way: every float in
...
#: 150-game audit run at layout v2.3 finds it live. This is the same sampling trap that made an
...
def test_the_decision_context_reaches_the_model(rows) -> None:
    """v2.3's whole point: the network is told what it is being asked, not just the board.
